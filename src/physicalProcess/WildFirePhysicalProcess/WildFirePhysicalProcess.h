...
enum class sensingModel { SPATIAL_SENSE, DISK_MODEL, DISTANCE_DISK_MODEL, PROB_MODEL, PROB_SPATIAL_SENSE, UNKNOWN, LINEAR_DISTANCE_DISK_MODEL, EAS_MODEL };
...
class WildFirePhysicalProcess: public CastaliaModule {
 ...
 protected:
    ...
    double calculateEASModelSensorValue(CellState **states);
