...
class msr2mrp: public VirtualRouting {
    ...
    protected:
        ...
        msr2mrp_node_ext_entry getMaxTRe(std::vector<msr2mrp_node_ext_entry>);

        static double calculateInvPkt(msr2mrp_node_entry);
        static double calculatePkt(msr2mrp_node_entry);
        static double calculateInvHop(msr2mrp_node_entry);
    ...
    public:
        ...
        void extSetTimer(int machine, int index, simtime_t time);
        simtime_t extGetTimer(int machine, int index);
        void extCancelTimer(int machine, int index);
        void updateTimer();
        ...
        virtual void dumpRouting(YAML::Emitter &out);
};
